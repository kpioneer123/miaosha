package com.kpioneer.service.impl;


import com.kpioneer.dao.OrderDOMapper;
import com.kpioneer.dao.SequenceDOMapper;
import com.kpioneer.dataobject.OrderDO;
import com.kpioneer.dataobject.SequenceDO;
...
public class OrderServiceImpl implements OrderService {
    ...
    public String generateOrderNo() throws BusinessException {
        ...
        if (sequenceDO == null || sequenceDO.getCurrentValue() == null) {
            throw new BusinessException(EmBusinessError.GENERATE_ORDERNO_FAIL);
        }
        sequence = sequenceDO.getCurrentValue();
        /**
         * 省略步骤
         * CurrentValue 在表中 需要一个最大值 maxValue
         * maxValue 最大值
         * initvalue 初始值
         *
         * 当前CurrentValue >maxValue, CurrentValue设置initvalue
         */
