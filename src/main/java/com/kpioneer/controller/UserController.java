...
import com.kpioneer.controller.viewobject.UserVO;
...
//        this.httpServletRequest.getSession().setAttribute("LOGIN_USER", userModel);
    ...
    public CommonReturnType register(@RequestParam(name = "telphone") String telphone,
        ...
        System.out.println("telphone = " + telphone.trim());

        //验证手机号和对应的otpcode相符合
        String inSessionOtpCode = (String) this.httpServletRequest.getSession().getAttribute(telphone.trim());
    ...
    public CommonReturnType getOtp(@RequestParam(name = "telphone") String telphone) {
        ...
        //将OTP验证码同对应用户的手机号关联,使用httpsession的方式绑定他的手机号与OTP验证码
        httpServletRequest.getSession().setAttribute(telphone.trim(), otpCode.trim());
